...
```
![ヒストグラム](https://github.com/utaka233/garage/blob/master/imgs/histogram_of_x.png "ヒストグラム")
...
```
![EMアルゴリズムの更新履歴](https://github.com/utaka233/garage/blob/master/imgs/history_LL.png "EMアルゴリズムの更新履歴")
